...
const ShareCard = ({
  ...
  const getRank = () => {
    ...
    if (totalVolume >= 100) {
      return { title: "WARRIOR", emoji: "⚔️", tier: 3 };
    }
    if (totalVolume >= 50) {
      return { title: "FIGHTER", emoji: "💪", tier: 2 };
    }
  ...
  return (
    ...
    >
      ...
      {[
        ...
        <div className={`absolute ${pos} h-8 w-8 opacity-60`} key={pos}>
          <svg aria-hidden="true" fill="#8B0000" viewBox="0 0 32 32">
